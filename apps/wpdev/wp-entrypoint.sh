...
EOCONF
	...
	(cd /var/www/html/${SITEURL} && /usr/local/bin/wp core install  --allow-root --url=wpdev.lamill.io --title="Lamill Websystems" --admin_user=${SITEADMIN} --admin_password=${ADMINPASS} --admin_email=vik@lamill.us)
